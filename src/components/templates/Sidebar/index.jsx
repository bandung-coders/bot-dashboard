...
const Sidebar = (props) => {
  ...
  return (
    <div className={`main-sidebar${isActive ? " active" : ""}`}>
      <div className="sidebar-header">
        <div
          className="sidebar-logo"
          onClick={() => {
            // window.location.href = "https://resitdc.id";
          }}
        >
          ...
          <div className="sidebar-logo-title">RESITDC</div>
        </div>
        <button className="close-sidebar" onClick={handleOnClose}>
          <span className="resitdc icon-x"></span>
        </button>
      </div>
